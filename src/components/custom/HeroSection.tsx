  ...
  return (
    <div className="relative flex w-full h-screen items-center justify-center">
      ...
      <BackgroundGradientAnimation className="relative z-30 flex w-full h-screen items-center justify-center">
        <div className="flex flex-col items-center justify-center w-full md:w-8/12 h-full pl-4 md:pl-10 ">
          <div className="max-w-screen-lg w-full text-center mb-12">
            ...
            <div className="flex space-x-4 justify-center">
              ...
              <button className="relative inline-flex h-12 overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-black px-4 py-5 text-xl text-white backdrop-blur-3xl">
                  My Resume
