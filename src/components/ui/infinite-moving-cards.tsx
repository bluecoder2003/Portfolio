  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-bgdark px-6 py-6 md:w-[450px]"
            style={{
              background:
                "linear-gradient(180deg, var(--bg-black), var(--bg-bgdark))",
            }}
            key={item.name}
          >
            <blockquote>
