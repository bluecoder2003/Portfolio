  ...
  return (
    <div className="flex w-full flex-col min-h-screen overflow-hidden justify-center items-center">
      ...
      <div className="flex flex-col items-center justify-center space-y-4 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-lg md:text-xl lg:text-xl py-10 text-center text-[#746D80] px-4 sm:px-6 lg:px-8">
          ...
          {[1, 2, 3].map((item, index) => (
            <div key={index} className="flex flex-col md:flex-row gap-6">
              <div className="flex flex-col flex-1">
                <div className="text-lg md:text-xl font-normal lg:text-xl text-bglight text-center flex flex-row">
                  Product Designer Intern, <div className="gradient-text">Vexio</div>
                </div>
                <div className="text-lg md:text-xl font-normal italic lg:text-xl text-bglight text-center">
