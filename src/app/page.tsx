...
<div className="flex flex-col md:flex-row gap-8 md:gap-20">
  ...
  <div className="py-8 md:py-16">
    <Card text="Work in Development" imageSrc="/assets/ss_vscode.svg" />
      ...
      <div
        className="flex flex-row-reverse items-start justify-start space-x-20 mr-20 py-10"
        style={{ textAlign: "justify" }}
      >
        <img src="/assets/my_pic.png" alt="My Picture" className="w-full h-96" />
        <div className="flex flex-col items-start justify-start space-y-4">
          <div className="text-lg md:text-xl font-semibold lg:text-xl text-start gradient-text">
            ABOUT ME
          </div>
          <div className="text-lg md:text-xl lg:text-5xl text-start text-bglight">
            Know who I am
          </div>
          <div className="text-lg md:text-xl lg:text-xl text-start text-[#746D80]">
            My journey in a few words
          </div>
          <div
            className="text-base md:text-base lg:text-lg text-start w-5/6 text-[#746D80]"
            style={{ textAlign: "justify" }}
          >
            Design has always been in my DNA. As a kid you would find me dabbling my
            hands in paint and making random abstract art, and I grew to like how
            technology became a very integral part of expressing our creativity over
            the years. I stumbled upon UX/UI which was a perfect combination of both.
            I look forward to my journey in this field after transitioning from a
